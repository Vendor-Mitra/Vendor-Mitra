...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result.success) {
        // Get the logged in user from localStorage to check type
        const loggedInUser = JSON.parse(localStorage.getItem('vendorMitraUser'))
        // Redirect based on user type
        if (loggedInUser && (loggedInUser.type === 'supplier' || loggedInUser.userType === 'supplier')) {
