...
const FlashSalesDisplay = ({ onAddToCart }) => {
  ...
  const handlePurchase = (flashSale) => {
    ...
    // DON'T decrease stock here - only decrease when actually purchasing in Cart.jsx
    // This is just adding to cart, not completing the purchase
    console.log(`Flash sale item added to cart: ${flashSale.product}`)
  }
