...
import productApi from '../services/smartProductApi'
...
export const ProductProvider = ({ children }) => {
  ...
  const loadProducts = async () => {
    ...
    try {
      ...
      if (response.success) {
        ...
        console.log('ProductContext: Loading products with duplicate removal:', uniqueProducts.length, 'unique products')
  ...
  useEffect(() => {
    const unsubscribe = productApi.subscribeToUpdates((data) => {
      console.log('Real-time product update received in ProductContext:', data)
      console.log('Current products count before update:', products.length)
      ...
      switch (data.action) {
        case 'create':
          setProducts(prev => {
            ...
            console.log('Products count after adding:', prev.length + 1)
